  ...
  if (stage === "intro") {
    return (
      <div className="grain fixed inset-0 z-40 flex flex-col items-center justify-center bg-ink px-6 text-center">
        <div
          className="pointer-events-none absolute inset-0 bg-cream anim-flash"
        ...
        <h2
          className="editorial anim-fade-up relative z-2 text-5xl tracking-tight text-cream sm:text-7xl"
        ...
        <p
          className="overline anim-fade relative z-2 mt-6 text-[0.6rem] text-chrome"
        ...
        <button
          ...
          className="overline absolute bottom-8 z-2 text-[0.55rem] text-cream/40"
        >
          skip
        </button>
      </div>
          ...
          {CELEB_STATS.map((s, i) => (
            <Reveal key={s.label} delay={i * 80}>
              <div className="border border-chrome/15 bg-cream/[0.03] p-4 text-center">
                ...
                <p className="overline mt-2 text-[0.5rem] text-chrome">
                  {s.label}
                </p>
              </div>
            </Reveal>
            ...
            <Reveal key={a.label} delay={i * 60}>
              <div>
                <div className="flex items-baseline justify-between">
                  <span className="editorial text-xl text-cream">
                    {a.label}
                  </span>
