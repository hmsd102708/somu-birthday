    ...
    return (
      ...
      >
        <div className="relative z-2 mx-auto w-full max-w-3xl px-5 pt-6 pb-24 sm:px-8">
          ...
          <p className="overline anim-fade text-[0.6rem] opacity-60">
            {era.emoji} Era
          </p>

          <h1 className="editorial anim-fade-up mt-3 text-5xl sm:text-7xl">
            {era.name}
          </h1>

          <p
            className="hand anim-fade-up mt-4 text-2xl opacity-80"
  ...
  return (
    <SectionShell onBack={onBack} label="Eras">
      <header className="mb-10">
        <h1 className="editorial text-5xl text-wine sm:text-7xl">
          Somu's Eras
        </h1>

        <p className="hand mt-2 text-xl text-rose">
          four moods, one woman, no warning
        </p>
      </header>
        ...
        {ERAS.map((e, i) => (
          <Reveal key={e.id} delay={i * 70}>
            <button
              ...
              className={cn(
                "lift flex min-h-36 w-full flex-col justify-between rounded-sm p-5 text-left",
                themeClass[e.theme],
              )}
            >
              ...
              <span>
                <span className="editorial block text-2xl">
                  {e.name}
                </span>
